...
<body>
    ...
    <script>
        function submitForm() {
            ...
            if (!nip || !email || !fullName || !password || !phoneNumber || !role) {
                Swal.fire({
                    icon: 'error',
                    title: 'Aaw...',
